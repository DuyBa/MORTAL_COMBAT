...
class Fighting():
	...
	game_stop=False
	def play_immediately(self, totally_quit, run_of_pause, run_of_fighting, run_of_main, run_of_end):
		...
		while run_of_fighting[0]:
			...
			if score[0]	==2 or score[1]==2:
				while run_of_end[0]:
					...
					end.End(totally_quit, run_of_pause, run_of_fighting, run_of_main,run_of_end, screen)
